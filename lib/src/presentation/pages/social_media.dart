...
import 'package:social_media_gallery_picker/src/core/functions.dart';
import 'package:social_media_gallery_picker/src/data/models/gallery_params_model.dart';
import 'package:social_media_gallery_picker/src/data/models/picked_asset_model.dart';
import 'package:social_media_gallery_picker/src/presentation/pages/social_media_gallery_controller.dart';
import 'package:social_media_gallery_picker/src/presentation/widgets/gallery_grid_view.dart';
import 'package:social_media_gallery_picker/src/presentation/widgets/select_album_path/current_path_selector.dart';

class SocialMediaGalleryPicker extends StatefulWidget {
  /// params model
  ...
  const SocialMediaGalleryPicker({
    Key? key,
  ...
  @override
  State<SocialMediaGalleryPicker> createState() => _GalleryMediaPickerState();
}

class _GalleryMediaPickerState extends State<SocialMediaGalleryPicker> {
